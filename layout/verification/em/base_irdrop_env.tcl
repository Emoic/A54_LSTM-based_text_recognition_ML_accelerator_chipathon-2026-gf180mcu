...
set ::env(CURRENT_SPEF_DEFAULT_CORNER) /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/runs/lstm16x_22pin_clean4/55-openroad-rcx/nom/lstm16x_top.nom.spef
...
set ::env(DESIGN_NAME) lstm16x_top
...
set ::env(EXTRA_EXCLUDED_CELLS) "gf180mcu_fd_sc_mcu7t5v0__nor2_1 gf180mcu_fd_sc_mcu7t5v0__nor3_1"
set ::env(FALLBACK_SDC) /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/constraints.sdc
set ::env(PAD_EDGE_SPACING) 0
set ::env(SET_RC_VERBOSE) 0
set ::env(PDN_CONNECT_MACROS_TO_GRID) 1
set ::env(PDN_ENABLE_GLOBAL_CONNECTIONS) 1
set ::env(PNR_SDC_FILE) /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/constraints.sdc
set ::env(DEDUPLICATE_CORNERS) 0
set ::env(CURRENT_ODB) /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/runs/lstm16x_22pin_clean4/54-odb-cellfrequencytables/lstm16x_top.odb
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/runs/lstm16x_22pin_clean4/55-openroad-rcx/nom/lstm16x_top.nom.spef \"min_*\" /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/runs/lstm16x_22pin_clean4/55-openroad-rcx/min/lstm16x_top.min.spef \"max_*\" /foss/designs/lstm16x_int8_gf180_1000x1000/synthesis/runs/lstm16x_22pin_clean4/55-openroad-rcx/max/lstm16x_top.max.spef"
